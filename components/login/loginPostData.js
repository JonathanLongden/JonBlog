...
var LoginPostForm = require('./loginPostForm');

var LoginPostData = React.createClass({
	...
	handleNewUserPost: function(user){
	  ...
	  render: function(){
	    return (
	      <div>
				<h1></h1>
				<LoginPostForm 	handleUserSubmit={this.handleUserSubmit} 
